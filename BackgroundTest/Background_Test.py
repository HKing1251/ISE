...
#background image
background_image = pygame.image.load(r'BackgroundTest/Bg1.png')
...
#speaker images
speaker_left1 = pygame.image.load(r'BackgroundTest/SpeakRight1.png')
speaker_left2 = pygame.image.load(r'BackgroundTest/SpeakRight2.png')
speaker_right1 = pygame.image.load(r'BackgroundTest/SpeakLeft1.png')
speaker_right2 = pygame.image.load(r'BackgroundTest/SpeakLeft2.png')
# Adjust dimensions
...
def draw_background(surface):
    ...
    global last_speed_change, use_first_image
    ...
    for event in pygame.event.get([speaker_swap_event, spotlight_effect_event, color_change_event, pattern_change_event]):
        if event.type == speaker_swap_event:
    ...
    # Draw darkened background and lights
    surface.blit(darkened_bg, (0, 0))
    for spotlight in spotlights:
        spotlight.draw(surface)

    # Draw speakers
    if use_first_image:
        surface.blit(speaker_left1, left_speaker_pos)
        surface.blit(speaker_right1, right_speaker_pos)
    else:
        surface.blit(speaker_left2, left_speaker_pos)
        surface.blit(speaker_right2, right_speaker_pos)
